...
public class DebugUIBuilder : MonoBehaviour
{
  ...
  public GameObject introPosition;
  public GameObject UIPosition;
  public GameObject task1Position;
  public GameObject task2Position;
  ...
  public void Awake()
  {
    ...
    instance = this;
    // Using Empty Gameobject's transform that is offset from HeadsetAlias for the transform position of the Menu UI
    //menuOffset = transform.position; // TODO: this is unpredictable/busted
    //menuOffset = GetComponent<RectTransform>().position;
    ...
    // LaserPointer is a game object and script located in UIHelpers Prefab.  Which is instantiated in the previous statement above
  ...
  public void Show(CANVAS_POSITION canvasPos = CANVAS_POSITION.PLAYER_CAMERA)
  {
    Relayout();
    ...
    switch (canvasPos)
    {
        case CANVAS_POSITION.INTRO:
            transform.position = introPosition.transform.position;
            break;
        case CANVAS_POSITION.PLAYER_CAMERA:
            transform.position = UIPosition.transform.position;
            break;
        case CANVAS_POSITION.TASK1:
            transform.position = task1Position.transform.position;
            break;
        case CANVAS_POSITION.TASK2:
            transform.position = task2Position.transform.position;
            break;
        default:
            break;
    }
    
    // Calculate and set rotation of Menu
