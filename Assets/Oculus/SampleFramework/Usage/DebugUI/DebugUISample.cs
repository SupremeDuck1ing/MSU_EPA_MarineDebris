...
public class DebugUISample : MonoBehaviour
{
    ...
    public bool allowPlayerUI = false;

	void Start ()
    {
        DebugUIBuilder.instance.AddLabel("Marine Debris VR Module");
        DebugUIBuilder.instance.AddDivider();
        DebugUIBuilder.instance.AddLabel("This 3 part series will show how marine debris affects our waters and what you can do about it!");
        DebugUIBuilder.instance.AddDivider();
        DebugUIBuilder.instance.AddButton("Continue", LogButtonPressed);
        ...
        DebugUIBuilder.instance.Show(DebugUIBuilder.CANVAS_POSITION.INTRO);
        inMenu = true;
	}

    public void ShowMenu(DebugUIBuilder.CANVAS_POSITION menuPos)
    {
        DebugUIBuilder.instance.Show(menuPos);
        inMenu = true;
    }
